const fallbackViews = {
  id: {
    title: "ID",
    subtitle: "Carte d'identité du profil.",
    ascii: [
      "+-------------------------------------------------------------+",
      "| PROFILE_ID                                                  |",
      "+-------------------------------------------------------------+",
  ...
  cv: {
    title: "CV",
    subtitle: "Résumé rapide du parcours.",
    ascii: [
      "+-------------------------------------------------------------+",
      "| CURRICULUM_VITAE                                            |",
      "+-------------------------------------------------------------+",
    ...
    meta: [
      ...
      "> Méthodes: prototypage rapide puis refactor propre",
  ...
  taff: {
    title: "TAFF",
    subtitle: "Projets et réalisations principales.",
    ascii: [
      "+-------------------------------------------------------------+",
      "| WORK_LOG                                                    |",
      "+-------------------------------------------------------------+",
    ...
    meta: [
      ...
      "> Contraintes gérées: perf, scale, maintainability",
  ...
  stack: {
    title: "STACK",
    subtitle: "Technos et outils utilisés au quotidien.",
    ascii: [
      "+-------------------------------------------------------------+",
      "| TECH_STACK                                                  |",
      "+-------------------------------------------------------------+",
    ...
    meta: [
      ...
      "> Standard: lisible, testé, monitorable",
    ],
    actions: [
  ...
  contact: {
    title: "CONTACT",
    subtitle: "Canaux directs pour échanger.",
    ascii: [
      "+-------------------------------------------------------------+",
      "| CONTACT_CHANNELS                                            |",
      "+-------------------------------------------------------------+",
      ...
      "| NOTE     : réponse rapide sur sujets projet                |",
      "+-------------------------------------------------------------+",
    ],
    meta: [
      "> Type de mission: freelance, collaboration, build produit",
      "> Délai habituel de réponse: 24h",
      "> Brief conseillé: contexte, objectifs, deadline",
    ],
    actions: [
      { label: "[ SEND MAIL ]", href: "mailto:hello@1leeway.dev" },
      { label: "[ OPEN GITHUB ]", href: "https://github.com/1leeway" },
...
const staticI18n = {
  fr: {
    ...
    fastfetchLoading: "Démarrage fastfetch...",
    monitorLoading: "Démarrage du monitor...",
    ...
    fastfetch: {
      ...
      privacy: "mode-prive: données exposées par le navigateur seulement",
      refreshHint: "refresh: met à jour les métriques runtime et réseau",
      labels: {
        host: "Hôte",
        os: "OS",
        browser: "Navigateur",
